...
func Test_Utils_ETag(t *testing.T) {
	...
	t.Run("Not Status OK", func(t *testing.T) {
		...
		c.Status(201)
		setETag(c, false)
		utils.AssertEqual(t, "", string(c.request.Response.Header.Peek(HeaderETag)))
	})
	...
	t.Run("Has HeaderIfNoneMatch", func(t *testing.T) {
		...
		defer app.ReleaseCtx(c)
		c.SendString("Hello, World!")
		c.request.Request.Header.Set(HeaderIfNoneMatch, `"13-1831710635"`)
		setETag(c, false)
		utils.AssertEqual(t, 304, c.request.Response.StatusCode())
		utils.AssertEqual(t, "", string(c.request.Response.Header.Peek(HeaderETag)))
		utils.AssertEqual(t, "", string(c.request.Response.Body()))
	})
	...
	t.Run("No HeaderIfNoneMatch", func(t *testing.T) {
		...
		c.SendString("Hello, World!")
		setETag(c, false)
		utils.AssertEqual(t, `"13-1831710635"`, string(c.request.Response.Header.Peek(HeaderETag)))
	})
}
...
func Test_Utils_ETag_Weak(t *testing.T) {
	...
	t.Run("Set Weak", func(t *testing.T) {
		...
		c.SendString("Hello, World!")
		setETag(c, true)
		utils.AssertEqual(t, `W/"13-1831710635"`, string(c.request.Response.Header.Peek(HeaderETag)))
	})
	...
	t.Run("Match Weak ETag", func(t *testing.T) {
		...
		defer app.ReleaseCtx(c)
		c.SendString("Hello, World!")
		c.request.Request.Header.Set(HeaderIfNoneMatch, `W/"13-1831710635"`)
		setETag(c, true)
		utils.AssertEqual(t, 304, c.request.Response.StatusCode())
		utils.AssertEqual(t, "", string(c.request.Response.Header.Peek(HeaderETag)))
		utils.AssertEqual(t, "", string(c.request.Response.Body()))
	...
	t.Run("Not Match Weak ETag", func(t *testing.T) {
		...
		defer app.ReleaseCtx(c)
		c.SendString("Hello, World!")
		c.request.Request.Header.Set(HeaderIfNoneMatch, `W/"13-1831710635xx"`)
		setETag(c, true)
		utils.AssertEqual(t, `W/"13-1831710635"`, string(c.request.Response.Header.Peek(HeaderETag)))
	})
}
