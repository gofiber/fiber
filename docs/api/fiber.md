...
| <Reference id="skipunmatchedroutes">SkipUnmatchedRoutes</Reference>                   | `bool`                                                          | When enabled, requests whose path and method match no registered route are answered with `404` (or `405` when the path exists for other methods) immediately, before the middleware chain runs. This avoids spending work on requests to unregistered paths (bots, scanners, bad URLs).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | `false`                                                                |
