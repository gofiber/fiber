...
| Logger           | `fiberlog.AllLogger`  | Logger allows the use of a custom logger that implements the AllLogger interface. This field can be used in the LoggerFunc to do the logging. If you don't define LoggerFunc, it'll use the default logger of Fiber without using this field. |  `nil`                                                        |
