...
func Test_isValidToken68(t *testing.T) {
	...
	cases := []struct {
		...
		{token: "abcdefgh", want: true, name: "exactly one word"},
		{token: "abcdefg,", want: false, name: "invalid byte at word tail"},
		{token: "abcdefghijklmno\x00", want: false, name: "NUL in overlapping word"},
