...
Go가 설치되어 있는 것을 확인해 주세요 ([download](https://go.dev/dl/)). 버전 1.20 또는 그 이상이어야 합니다.
...
-   Fiber는 unsafe 패키지를 사용하기 때문에 최신 Go버전과 호환되지 않을 수 있습니다. Fiber 3.0.0은 Go 버전 1.20부터 1.22까지 테스트되고 있습니다.
