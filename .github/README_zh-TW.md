...
-   被翻譯成[15 種語言](https://docs.gofiber.io/)
...
| [compress](https://github.com/gofiber/fiber/tree/master/middleware/compress)           | CFiber 的壓縮中間件，默認支持`deflate`、`gzip`和`brotli`。                                                                                                     |
