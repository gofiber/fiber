...
Убедитесь, что Go установлен ([скачать](https://go.dev/dl/)). Требуется версия `1.20` или выше.
...
-   Из-за того, что Fiber использует пакет unsafe, библиотека не всегда может быть совместима с последней версией Go. Fiber 3.0.0 был протестирован с версиями Go от 1.20 до 1.22.
