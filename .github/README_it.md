...
Assicurati di avere Go ([per scaricarlo](https://go.dev/dl/)) installato. Devi avere la versione `1.20` o superiore.
...
-   Dato che Fiber utilizza unsafe, la libreria non sempre potrebbe essere compatibile con l'ultima versione di Go. Fiber 3.0.0 è stato testato con la versioni 1.20 alla 1.22 di Go.
