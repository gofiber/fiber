...
func Test_Session_Store_Reset(t *testing.T) {
	...
	utils.AssertEqual(t, nil, sess.Save(context.TODO()))

	// reset store
	utils.AssertEqual(t, nil, store.Reset(context.TODO()))
...
func Test_Session_Reset(t *testing.T) {
	...
	t.Run("reset from cookie", func(t *testing.T) {
		...
		sess.Set("name", "fenny")
		utils.AssertEqual(t, nil, sess.Destroy(context.TODO()))
		name := sess.Get("name")
		utils.AssertEqual(t, nil, name)
	})
...
func Test_Session_Regenerate(t *testing.T) {
	...
	t.Run("set fresh to be true when regenerating a session", func(t *testing.T) {
		...
		err = freshSession.Save(context.TODO())
		utils.AssertEqual(t, nil, err)
		...
		err = acquiredSession.Regenerate(context.TODO())
		utils.AssertEqual(t, nil, err)
