...
func Test_ETag_NewEtag(t *testing.T) {
	...
	t.Run("with HeaderIfNoneMatch and not matched", func(t *testing.T) {
		t.Parallel()
		testETagNewEtag(t, `"non-match"`)
	})
	t.Run("with HeaderIfNoneMatch and matched", func(t *testing.T) {
		t.Parallel()
		testETagNewEtag(t, `"13-1831710635"`)
	})
}

func testETagNewEtag(t *testing.T, headerIfNoneMatch string) {
	t.Helper()
	...
	if headerIfNoneMatch != `"13-1831710635"` {
		require.Equal(t, fiber.StatusOK, resp.StatusCode)
...
func Test_ETag_WeakEtag(t *testing.T) {
	...
	t.Run("with HeaderIfNoneMatch and not matched", func(t *testing.T) {
		t.Parallel()
		testETagWeakEtag(t, `W/"non-match"`)
	})
	t.Run("with HeaderIfNoneMatch and matched", func(t *testing.T) {
		t.Parallel()
		testETagWeakEtag(t, `W/"13-1831710635"`)
	})
}

func testETagWeakEtag(t *testing.T, headerIfNoneMatch string) {
	t.Helper()
	...
	if headerIfNoneMatch != `W/"13-1831710635"` {
		require.Equal(t, fiber.StatusOK, resp.StatusCode)
...
func Test_ETag_CustomEtag(t *testing.T) {
	...
	t.Run("without HeaderIfNoneMatch", func(t *testing.T) {
		t.Parallel()
		testETagCustomEtag(t, "")
	})
	t.Run("with HeaderIfNoneMatch and not matched", func(t *testing.T) {
		t.Parallel()
		testETagCustomEtag(t, `"non-match"`)
	})
	t.Run("with HeaderIfNoneMatch and matched", func(t *testing.T) {
		t.Parallel()
		testETagCustomEtag(t, `"custom"`)
	})
}

func testETagCustomEtag(t *testing.T, headerIfNoneMatch string) {
	t.Helper()
