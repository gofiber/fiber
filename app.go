...
type App[TRouter Router] struct {
	...
	// TODO: the router should handle these metrics -> getters ?
...
func NewWithRouter[TRouter Router](router TRouter, config ...Config) *App[TRouter] {
	...
	app := &App[TRouter]{
		...
		customBinders: []CustomBinder{},
		router:        router,
		// TODO: check this ? router should know about this ? getter ?
		latestRoute: &routing.Route{},
	}
...
func (app *App[TRouter]) requestHandler(rctx *fasthttp.RequestCtx) {
