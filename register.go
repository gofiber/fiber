...
func (r *Registe) All(handlers ...Handler) Register {
...
func (r *Registe) Get(handlers ...Handler) Register {
...
func (r *Registe) Route(path string) Register {
	// Create new group
	route := &Registe{app: r.app, path: getGroupPath(r.path, path)}
