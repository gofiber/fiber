...
func (app *App) gracefulShutdown(ctx context.Context, cfg *ListenConfig) {
	...
	// them again here or they would run twice.
	if cfg != nil && cfg.ShutdownTimeout != 0 {
		_ = app.ShutdownWithTimeout(cfg.ShutdownTimeout) //nolint:contextcheck // TODO: Implement it
	} else {
		_ = app.Shutdown() //nolint:contextcheck // TODO: Implement it
	}
}
